...
namespace ADONET_3_Layers_GiaoDien
{
    public partial class Form1 : Form
    {
        ...
        private void btnNew_Click_1(object sender, EventArgs e)
        {
            ...
            DialogResult res = MessageBox.Show("Do you want to Add Product?", "Wait", MessageBoxButtons.YesNo);
            if (res == DialogResult.Yes)
            {
                Handler.insertProducts( name, supplierID, categoryID, quantity, price, stock, order, reorder, discontinued);
                loadListOfProductToDataGridView();
            }
        }
